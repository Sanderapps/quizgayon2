        ...
        >
          <div className="mx-auto w-full max-w-3xl rounded-2xl border border-slate-200/80 bg-white/96 p-4 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-[#0a0f19]/96">
            <div className="mb-4 flex items-start justify-between gap-3">
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Painel da rádio</div>
                <div className="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-50">Programação atual e pedidos</div>
              </div>
              <button
                type="button"
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-2.5 md:py-3 flex items-center gap-3">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <button
              ...
              className="flex flex-1 min-w-0 items-center gap-3 rounded-xl border border-slate-200/80 bg-white/85 px-3 py-2 text-left shadow-sm transition-colors hover:bg-white dark:border-white/8 dark:bg-white/[0.03] dark:hover:bg-white/[0.06]"
            >
